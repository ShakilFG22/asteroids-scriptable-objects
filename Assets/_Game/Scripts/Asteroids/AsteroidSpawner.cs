...
namespace Asteroids
{
    public class AsteroidSpawner : MonoBehaviour
    {
        ...
        // public float _maxSpawnTime; //OG 4
        ...
        {
            _nextSpawnTime = Random.Range(mySO._minSpawnTime, mySO._maxSpawnTime);
        }
        ...
        private void Spawn()
        {
            var amount = Random.Range(mySO._minAmount, mySO._maxAmount + 1);
